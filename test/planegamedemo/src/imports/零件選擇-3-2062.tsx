...
import img from "figma:asset/00565327d591df2faded0f081abc632b354b5a1b.png";
...
function Component10() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0" data-name="名稱">
      <p className="font-['GenSenRounded_TW:H',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-white">硬木材料機翼</p>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[29px] shrink-0 w-full" data-name="說明">
      <p className="flex-[1_0_0] font-['GenSenRounded_TW:R',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[35px] text-white whitespace-pre-wrap">以厚實木材打造的機翼，結構簡單但可靠，飛行時給人穩定、緩慢前進的感覺。</p>
    </div>
  );
}
