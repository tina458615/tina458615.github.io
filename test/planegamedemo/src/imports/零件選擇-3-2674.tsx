...
import img from "figma:asset/e9328403d437470a5f845319ebedcae13e0113ed.png";
...
function Component10() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0" data-name="名稱">
      <p className="font-['GenSenRounded_TW:H',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-white">金屬長筒型渦輪引擎</p>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[29px] shrink-0 w-full" data-name="說明">
      <p className="flex-[1_0_0] font-['GenSenRounded_TW:R',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[35px] text-white whitespace-pre-wrap">厚重金屬構成的渦輪引擎，聲響低沉有力，展現強烈工業風格。</p>
    </div>
  );
}
