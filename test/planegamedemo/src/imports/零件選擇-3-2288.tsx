...
import img from "figma:asset/976d75ade3f4672024a3783bb842e56f800f2965.png";
...
function Component10() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0" data-name="名稱">
      <p className="font-['GenSenRounded_TW:H',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-white">厚紙板機翼</p>
    </div>
  );
}
