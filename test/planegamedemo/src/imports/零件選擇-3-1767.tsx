...
import img3 from "figma:asset/405148514789eefcd5a89d47657c87b8ea30d559.png";
import img4 from "figma:asset/1f8a132b288aa488afaab3c0fbaf6fbe7fdddc0d.png";
import img5 from "figma:asset/7bc9fc436980d9a85babcf2fb7012aed4aab284e.png";
import img6 from "figma:asset/8b384a16bb9ac7519afeab099bacabeb7d02df93.png";
...
function Component5() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[600px] left-1/2 top-1/2 w-[800px]" data-name="預覽-機身">
      <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={img3} />
    </div>
  );
}
...
function Component10() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0" data-name="名稱">
      <p className="font-['GenSenRounded_TW:H',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-white">碳纖維機身</p>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[29px] shrink-0 w-full" data-name="說明">
      <p className="flex-[1_0_0] font-['GenSenRounded_TW:R',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[35px] text-white whitespace-pre-wrap">輕量又堅固的先進材料機身，外觀低調但效率極高。</p>
    </div>
  );
}
...
function Component12() {
  return (
    <div className="content-stretch flex flex-col font-['GenSenRounded_TW:B',sans-serif] gap-[20px] items-center justify-center leading-[normal] not-italic relative rounded-[29px] shrink-0 text-[40px] text-white w-full whitespace-pre-wrap" data-name="數值">
      <p className="relative shrink-0 w-full">所需資金：300</p>
      <p className="relative shrink-0 w-full">5000噸的能量石失去能量</p>
      <p className="relative shrink-0 w-full">建造時間：20秒</p>
    </div>
  );
}
