...
import img from "figma:asset/93738a2fbe4aac1931b847b78b512439c18fe9a5.png";
...
import img3 from "figma:asset/1f8a132b288aa488afaab3c0fbaf6fbe7fdddc0d.png";
import img4 from "figma:asset/b889460ac904646b726b5edf4220cc843ff9f763.png";
import img5 from "figma:asset/645176653ad3bd492bdd30e7ee3fbaf1fc39d4bb.png";
import img6 from "figma:asset/9a8ae781e76182cd4f5341e99361ee002970fb53.png";
import img7 from "figma:asset/8b384a16bb9ac7519afeab099bacabeb7d02df93.png";
import img8 from "figma:asset/61e9244a0cc381f2394a08297eb284233be5c51b.png";
...
function Component10() {
  return (
    <div className="content-stretch flex items-center py-[5px] relative shrink-0" data-name="名稱">
      <p className="font-['GenSenRounded_TW:H',sans-serif] leading-[normal] not-italic relative shrink-0 text-[50px] text-white">厚紙板螺旋槳</p>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[29px] shrink-0 w-full" data-name="說明">
      <p className="flex-[1_0_0] font-['GenSenRounded_TW:R',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[35px] text-white whitespace-pre-wrap">以實木削製的螺旋槳，轉動節奏緩慢而穩定，飛行時多層紙板壓製成型，重量輕、結構單純，是早期飛行常見的實驗動力。給人安心可靠的感覺。</p>
    </div>
  );
}
...
function Component12() {
  return (
    <div className="content-stretch flex flex-col font-['GenSenRounded_TW:B',sans-serif] gap-[20px] items-center justify-center leading-[normal] not-italic relative rounded-[29px] shrink-0 text-[40px] text-white w-full whitespace-pre-wrap" data-name="數值">
      ...
      <p className="relative shrink-0 w-full">5000噸的能量石失去能量</p>
